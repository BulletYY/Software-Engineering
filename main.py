...
summary, df = flexible_fourier_form( fdt, "BIC", vol_estimation="egarch", days=['Wednesday','Monday','Thursday','Tuesday'], plots=True, session_thresholds=['90000', '165000'],max_lags_kernel='bartlett',verbose=False)
